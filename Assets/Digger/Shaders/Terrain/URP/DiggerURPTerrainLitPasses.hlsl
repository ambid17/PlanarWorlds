...
#ifdef _MASKMAP
    float2 _TerrainSizeInv = float2(_TerrainWidthInv, _TerrainHeightInv);
    masks[0] = lerp(masks[0], SampleTriplanar(IN.positionWS, IN.normal.xyz, _Mask0, sampler_Mask0, _Splat0_ST.xy * _TerrainSizeInv, _Splat0_ST.zw), hasMask.x);
    masks[1] = lerp(masks[1], SampleTriplanar(IN.positionWS, IN.normal.xyz, _Mask1, sampler_Mask0, _Splat0_ST.xy * _TerrainSizeInv, _Splat0_ST.zw), hasMask.y);
    masks[2] = lerp(masks[2], SampleTriplanar(IN.positionWS, IN.normal.xyz, _Mask2, sampler_Mask0, _Splat0_ST.xy * _TerrainSizeInv, _Splat0_ST.zw), hasMask.z);
    masks[3] = lerp(masks[3], SampleTriplanar(IN.positionWS, IN.normal.xyz, _Mask3, sampler_Mask0, _Splat0_ST.xy * _TerrainSizeInv, _Splat0_ST.zw), hasMask.w);
#endif
...
half4 SplatmapFragment(Varyings IN) : SV_TARGET
{
    ...
    SplatmapMix(IN.positionWS, IN.normal.xyz, IN.uvMainAndLM, IN.uvSplat01, IN.uvSplat23, splatControl, weight, mixedDiffuse, defaultSmoothness, normalTS);
