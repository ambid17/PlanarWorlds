...
public class TexturePaint : MonoBehaviour {
    ...
    // ---------------------------------
    private PaintableTexturee albedo;
    private PaintableTexturee metalic;
    public  PaintableTexturee smoothness;
    // ======================================================================================================================
    // INITIALIZE -------------------------------------------------------------------
    ...
    void Start () {
        ...
        albedo         = new PaintableTexturee(Color.white, baseTexture.width, baseTexture.height, "_MainTex"
            ,UVShader, meshToDraw, fixIlsandEdgesShader,markedIlsandes);
        metalic        = new PaintableTexturee(Color.white, baseTexture.width, baseTexture.height, "_MetallicGlossMap"
              , UVShader, meshToDraw, fixIlsandEdgesShader, markedIlsandes);

        smoothness     = new PaintableTexturee(Color.black, baseTexture.width, baseTexture.height, "_GlossMap"
              , UVShader, meshToDraw, fixIlsandEdgesShader, markedIlsandes);
    ...
    private void Update()
    {
        ...
        Shader.SetGlobalVector("_MousePosition", mwp);
    }
...
[System.Serializable]
public class PaintableTexturee
{
    public  string        id;
    ...
    public PaintableTexturee(Color clearColor, int width, int height, string id, 
