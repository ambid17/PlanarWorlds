...
namespace RTG
{
    ...
    public class Hotkeys
    {
        ...
        public bool IsActive(bool checkForOverlaps = true)
        {
            ...
            if (Key != KeyCode.None && !RTInput.IsKeyPressed(Key)) return false;
            ...
            if (_lCtrl && !RTInput.IsKeyPressed(KeyCode.LeftControl)) return false;
            if (_lCmd && !RTInput.IsKeyPressed(KeyCode.LeftCommand)) return false;
            if (_lAlt && !RTInput.IsKeyPressed(KeyCode.LeftAlt)) return false;
            if (_lShift && !RTInput.IsKeyPressed(KeyCode.LeftShift)) return false;
            ...
            if (_lMouseBtn && !RTInput.IsLeftMouseButtonPressed()) return false;
            if (_rMouseBtn && !RTInput.IsRightMouseButtonPressed()) return false;
            if (_mMouseBtn && !RTInput.IsMiddleMouseButtonPressed()) return false;
        ...
        public bool IsActiveInFrame(bool checkForOverlaps = true)
        {
            ...
            if (Key != KeyCode.None && !RTInput.WasKeyPressedThisFrame(Key)) return false;
            ...
            // Check if the corresponding mouse buttons are pressed
            if (_lMouseBtn && !RTInput.WasLeftMouseButtonPressedThisFrame()) return false;
            if (_rMouseBtn && !RTInput.WasRightMouseButtonPressedThisFrame()) return false;
            if (_mMouseBtn && !RTInput.WasMiddleMouseButtonPressedThisFrame()) return false;
        ...
        {
            if (RTInput.IsKeyPressed(KeyCode.LeftControl)) return true;
            if (RTInput.IsKeyPressed(KeyCode.LeftCommand)) return true;
            if (RTInput.IsKeyPressed(KeyCode.LeftAlt)) return true;
            if (RTInput.IsKeyPressed(KeyCode.LeftShift)) return true;
        ...
        {
            if (RTInput.IsLeftMouseButtonPressed()) return true;
            if (RTInput.IsRightMouseButtonPressed()) return true;
            if (RTInput.IsMiddleMouseButtonPressed()) return true;
